            ...
            <div className={`${mont.className} w-full`}>
                ...
                {loadingState === 'data exist' && (
                    <>
                        <div className="flex md:justify-between md:items-center md:flex-row flex-col gap-5 w-full">
                            ...
                            <div className={`w-full md:w-1/4 md:flex-row flex-col flex items-center gap-5 ${mont.className}`}>
                                ...
                                <div className="flex items-center gap-0.5 md:gap-5 w-full md:w-fit">
                                    ...
                                    <button type="button" onClick={() => router.push(`/data/siswa/update/${dataSiswa.nis}`)} className="px-4 py-2 w-full md:w-fit flex items-center justify-center gap-3 text-blue-700 bg-blue-100 dark:bg-blue-500/10 rounded-full hover:bg-blue-200 dark:hover:bg-blue-500/20" >
                        ...
                        <h1 className="font-medium text-2xl md:text-6xl dark:text-zinc-300">
                            {dataSiswa.nama_siswa}
                        </h1>
                        <hr className="my-3 w-full dark:opacity-30" />
