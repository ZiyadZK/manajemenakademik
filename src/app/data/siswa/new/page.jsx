    ...
    return (
        <MainLayoutPage>
            ...
            <div className={`flex md:items-center md:justify-between w-full md:flex-row flex-col gap-3`}>
                ...
                <button type="button" onClick={() => router.push('/data/siswa/new/import')} className="px-4 py-2 rounded-full bg-zinc-100 dark:bg-zinc-700/30 dark:hover:bg-zinc-700/50 hover:bg-zinc-200 flex items-center justify-center gap-3 dark:text-zinc-200">
                    ...
                    <div className="text-sm font-semibold space-y-5">
                        <div className="grid grid-cols-3 gap-2 md:gap-5">
                            <div className="space-y-1">
                                ...
                                <select onChange={e => setKelasForm(state => [e.target.value, state[1], state[2]])} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                            ...
                            <div className="space-y-1">
                                ...
                                <select onChange={e => setKelasForm(state => [state[0], e.target.value, state[2]])} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                            ...
                            <div className="space-y-1">
                                ...
                                <select onChange={e => setKelasForm(state => [state[0], state[1], e.target.value])} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                        ...
                        <div className="flex md:flex-row flex-col gap-5">
                            <div className="space-y-1 w-full md:w-1/2">
                                ...
                                <input required value={formData.nik} onChange={e => setFormData(state => ({...state, nik: e.target.value}))} type="text" className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan No Induk Kependudukan" />
                            </div>
                            <div className="space-y-1 w-full md:w-1/2">
                                <h1 className="text-xs dark:text-zinc-500">No Kartu Keluarga</h1>
                                <input required value={formData.no_kk} onChange={e => setFormData(state => ({...state, no_kk: e.target.value}))} type="text" className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan No Kartu Keluarga" />
                            </div>
                        </div>
                        <div className="space-y-1">
                            <h1 className="text-xs dark:text-zinc-500">Nama Panjang</h1>
                            <input required value={formData.nama_siswa} onChange={e => setFormData(state => ({...state, nama_siswa: e.target.value}))} type="text" className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Nama Panjang" />
                        </div>
                        <div className="grid grid-cols-2 gap-2 md:gap-5">
                            ...
                            <div className="space-y-1">
                                ...
                                <input type="text" required value={formData.tempat_lahir} onChange={e => setFormData(state => ({...state, tempat_lahir: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Tempat Lahir" />
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-2 md:gap-5">
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">Jenis Kelamin</h1>
                                <select required value={formData.jenis_kelamin} onChange={e => setFormData(state => ({...state, jenis_kelamin: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                            ...
                            <div className="space-y-1">
                                ...
                                <select required value={formData.agama} onChange={e => setFormData(state => ({...state, agama: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                        ...
                        <div className="grid grid-cols-2 gap-2 md:gap-5">
                            <div className="space-y-1">
                                ...
                                <select required value={formData.status_dalam_keluarga} onChange={e => setFormData(state => ({...state, status_dalam_keluarga: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                            ...
                            <div className="space-y-1">
                                ...
                                <select required value={formData.anak_ke} onChange={e => setFormData(state => ({...state, anak_ke: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                        ...
                        <div className="space-y-1">
                            ...
                            <input type="text" required value={formData.alamat} onChange={e => setFormData(state => ({...state, alamat: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Alamat" />
                        </div>
                        <div className="space-y-1">
                            <h1 className="text-xs dark:text-zinc-500">No Handphone Siswa</h1>
                            <input type="text" required value={formData.no_hp_siswa} onChange={e => setFormData(state => ({...state, no_hp_siswa: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan No Handphone Siswa" />
                        </div>
                        <div className="space-y-1">
                            <h1 className="text-xs dark:text-zinc-500">Asal Sekolah</h1>
                            <input type="text" required value={formData.asal_sekolah} onChange={e => setFormData(state => ({...state, asal_sekolah: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Asal Sekolah" />
                        </div>
                        <div className="grid grid-cols-2 gap-5">
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">Tahun Masuk</h1>
                                <input type="text" required value={formData.tahun_masuk} onChange={e => setFormData(state => ({...state, tahun_masuk: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Tahun Masuk Siswa" />
                            </div>
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">Kategori</h1>
                                <select required value={formData.kategori} onChange={e => setFormData(state => ({...state, kategori: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="space-y-1">
                                ...
                                <input type="text" required value={formData.nisn} onChange={e => setFormData(state => ({...state, nisn: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan NISN" />
                            </div>
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">NIS</h1>
                                <input type="text" required value={formData.nis} onChange={e => setFormData(state => ({...state, nis: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium focus:outline-blue-400 bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan NISN" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full md:pl-5 md:w-1/2">
                    ...
                    <div className="text-sm font-semibold space-y-5">
                        <div className="space-y-1">
                            ...
                            <input type="text" required value={formData.telp_ortu} onChange={e => setFormData(state => ({...state, telp_ortu: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Telp Orang Tua" />
                        </div>
                        <div className="grid grid-cols-2 gap-5">
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">Nama Ayah</h1>
                                <input type="text" required value={formData.nama_ayah} onChange={e => setFormData(state => ({...state, nama_ayah: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Nama Ayah" />
                            </div>
                            <div className="space-y-1">
                                <h1 className="text-xs  dark:text-zinc-500">Pekerjaan Ayah</h1>
                                <select required value={formData.pekerjaan_ayah} onChange={e => setFormData(state => ({...state, pekerjaan_ayah: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="space-y-1">
                                ...
                                <input type="text" required value={formData.nama_ibu} onChange={e => setFormData(state => ({...state, nama_ibu: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700" placeholder="Masukkan Nama Ayah" />
                            </div>
                            <div className="space-y-1">
                                <h1 className="text-xs dark:text-zinc-500">Pekerjaan Ibu</h1>
                                <select required value={formData.pekerjaan_ibu} onChange={e => setFormData(state => ({...state, pekerjaan_ibu: e.target.value}))} className="px-2 py-1 rounded border outline-none w-full font-medium bg-transparent cursor-pointer dark:text-white dark:border-zinc-700 dark:bg-zinc-700">
                    ...
                    <div className="mt-5 flex items-center justify-center gap-5 md:flex-row flex-col">
                        <button type="submit" className="w-full md:w-1/2 rounded-full bg-green-100 dark:bg-green-500/10 flex items-center justify-center gap-3 text-green-700  py-3 hover:bg-green-700 dark:hover:bg-green-500/50 hover:text-white hover:shadow-2xl focus:bg-green-700 focus:text-white focus:shadow-2xl transition-all duration-300">
                            <FontAwesomeIcon icon={faSave} className="w-4 h-4 text-inherit" />
                            Simpan Data
                        </button>
                        <button type="button" onClick={() => setFormData(siswaFormat)} className="w-full md:w-1/2 rounded-full bg-zinc-100 dark:bg-zinc-700/10 flex items-center justify-center gap-3 text-zinc-700 dark:text-white py-3 hover:bg-zinc-300 dark:hover:bg-zinc-700/50  hover:shadow-2xl focus:bg-zinc-300 focus:shadow-2xl transition-all duration-300">
