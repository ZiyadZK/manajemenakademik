        ...
        mySwal.fire({
            ...
            if(result.isConfirmed) {
                mySwal.fire({
                    ...
                    timer: 10000,
                    didOpen: async () => {
                        const result = await updateSiswaByNIS(params.nis, formData);
                        if(result.success) {
                            mySwal.fire({
                                icon: 'success',
                    ...
                    <form onSubmit={submitUpdate} className="mt-5">
                        <div className="flex md:justify-between md:items-center md:flex-row flex-col gap-5">
                            ...
                            <div className={`md:flex-row flex-col flex items-center gap-5 ${mont.className}`}>
                                <button type="submit" className="px-4 py-2 w-full md:w-fit flex items-center justify-center gap-3 text-green-700 bg-green-100 dark:bg-green-500/10 rounded-full hover:bg-green-200 dark:hover:bg-green-500/20" >
                        ...
                        <div className="flex gap-5 md:flex-row flex-col">
                            <div className="w-full space-y-3">
                                <h1 className="px-2 py-1 rounded-full text-xs font-bold text-white bg-zinc-800 dark:bg-zinc-700 w-fit">
                                    Data Pribadi
                                </h1>
                                <div className="text-sm font-semibold space-y-5">
                                    <div className="grid grid-cols-3 gap-5">
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData['kelas']} onChange={e => setFormData(state => state = {...state, kelas: e.target.value})} className="px-2 py-1 rounded border w-full font-medium bg-white dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData['rombel']} onChange={e => setFormData(state => state = {...state, rombel: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData['no_rombel']} onChange={e => setFormData(state => state = {...state, no_rombel: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            ...
                                            <input type="text" value={formData.nik} onChange={e => setFormData(state => state = {...state, nik: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan No Induk Kependudukan" />
                                        </div>
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">No Kartu Keluarga</h1>
                                            <input type="text" value={formData.no_kk} onChange={e => setFormData(state => state = {...state, no_kk: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan No Kartu Keluarga" />
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                                        <h1 className="text-xs dark:text-zinc-500">Nama Panjang</h1>
                                        <input type="text" value={formData.nama_siswa} onChange={e => setFormData(state => state = {...state, nama_siswa: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Nama Panjang" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                        ...
                                        <div className="space-y-1 dark:text-zinc-500">
                                            ...
                                            <input type="text" value={formData.tempat_lahir} onChange={e => setFormData(state => state = {...state, tempat_lahir: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Tempat Lahir" />
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Jenis Kelamin</h1>
                                            <select value={formData.jenis_kelamin} onChange={e => setFormData(state => state = {...state, jenis_kelamin: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData.agama} onChange={e => setFormData(state => state = {...state, agama: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData.status_dalam_keluarga} onChange={e => setFormData(state => state = {...state, status_dalam_keluarga: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <select value={formData.anak_ke} onChange={e => setFormData(state => state = {...state, anak_ke: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input type="text" value={formData.alamat} onChange={e => setFormData(state => state = {...state, alamat: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Alamat" />
                                    </div>
                                    <div className="space-y-1">
                                        <h1 className="text-xs dark:text-zinc-500">No Handphone Siswa</h1>
                                        <input type="text" value={formData.no_hp_siswa} onChange={e => setFormData(state => state = {...state, no_hp_siswa: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan No Handphone Siswa" />
                                    </div>
                                    <div className="space-y-1">
                                        <h1 className="text-xs dark:text-zinc-500">Asal Sekolah</h1>
                                        <input type="text" value={formData.asal_sekolah} onChange={e => setFormData(state => state = {...state, asal_sekolah: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Asal Sekolah" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Tahun Masuk</h1>
                                            <input type="text" value={formData.tahun_masuk} onChange={e => setFormData(state => state = {...state, tahun_masuk: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Tahun Masuk Siswa" />
                                        </div>
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Kategori</h1>
                                            <select value={formData.kategori} onChange={e => setFormData(state => state = {...state, kategori: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            ...
                                            <input type="text" value={formData.nisn} onChange={e => setFormData(state => state = {...state, nisn: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan NISN" />
                                        </div>
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">NIS</h1>
                                            <input type="text" value={formData.nis} onChange={e => setFormData(state => state = {...state, nis: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan NISN" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full space-y-3">
                                ...
                                <div className="text-sm font-semibold space-y-5">
                                    <div className="space-y-1">
                                        ...
                                        <input type="text" value={formData.telp_ortu} onChange={e => setFormData(state => state = {...state, telp_ortu: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Telp Orang Tua" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Nama Ayah</h1>
                                            <input type="text" value={formData.nama_ayah} onChange={e => setFormData(state => state = {...state, nama_ayah: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Nama Ayah" />
                                        </div>
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Pekerjaan Ayah</h1>
                                            <select value={formData.pekerjaan_ayah} onChange={e => setFormData(state => state = {...state, pekerjaan_ayah: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        <div className="space-y-1">
                                            ...
                                            <input type="text" value={formData.nama_ibu} onChange={e => setFormData(state => state = {...state, nama_ibu: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white" placeholder="Masukkan Nama Ayah" />
                                        </div>
                                        <div className="space-y-1">
                                            <h1 className="text-xs dark:text-zinc-500">Pekerjaan Ibu</h1>
                                            <select value={formData.pekerjaan_ibu} onChange={e => setFormData(state => state = {...state, pekerjaan_ibu: e.target.value})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                                <option value="" disabled>-- Pekerjaan Ayah --</option>
                                                <option value="Buruh">Buruh</option>
                                                <option value="Buruh Harian Lepas">Buruh Harian Lepas</option>
                                                <option value="Guru">Guru</option>
                                    ...
                                    <div className="text-sm font-semibold space-y-5">
                                        ...
                                        <div className="grid grid-cols-2 gap-5">
                                            <div className="space-y-1">
                                                ...
                                                <input type="date" value={dateToIso(formData.tanggal_lahir)} onChange={e => setFormData(state => state = {...state, tanggal_lahir: isoToDate(e.target.value)})} className="px-2 py-1 rounded border bg-white w-full font-medium" placeholder="Masukkan Tanggal Lahir" />
                                            </div>
                                            <div className="space-y-1">
                                                <h1 className="text-xs">Tempat Lahir</h1>
