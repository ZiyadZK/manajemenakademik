...
const formatDataPribadi = ['kelas', 'rombel', 'no_rombel', 'nama_siswa', 'nis', 'nisn', 'nik', 'no_kk', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'agama', 'status_dalam_keluarga', 'anak_ke', 'alamat', 'no_hp_siswa', 'asal_sekolah', 'kategori', 'tahun_masuk', 'tahun_keluar', 'tanggal_keluar']
...
const formatDataSiswa = ['kelas', 'rombel', 'no_rombel', 'nama_siswa', 'nis', 'nisn', 'nik', 'no_kk', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'agama', 'status_dalam_keluarga', 'anak_ke', 'alamat', 'no_hp_siswa', 'asal_sekolah', 'kategori', 'tahun_masuk', 'tahun_keluar', 'tanggal_keluar', 'nama_ayah', 'nama_ibu', 'telp_ortu', 'pekerjaan_ayah', 'pekerjaan_ibu']
const formatInformasiFile = {status: '', ekstensi: '', size: '', jumlahData: ''}
const mySwal = withReactContent(Swal)

export default function DataAlumniNewImportPage() {
