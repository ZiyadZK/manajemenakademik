...
const formatDataPribadi = ['kelas', 'nama_siswa', 'nis', 'nisn', 'nik', 'no_kk', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'agama', 'status_dalam_keluarga', 'anak_ke', 'alamat', 'no_hp_siswa', 'asal_sekolah', 'kategori', 'tahun_masuk', 'tahun_keluar', 'tanggal_keluar']
...
export default function DataAlumniNISPage({params}) {
        ...
        Swal.fire({
            ...
            if(result.isConfirmed) {
                Swal.fire({
                    ...
                    didOpen: async () => {
                        const response = await model_deleteAlumni([dataSiswa.nis])
                        if(response.success) {
                            Swal.fire({
                                title: 'Sukses',
                                icon: 'success',
