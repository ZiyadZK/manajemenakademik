                                ...
                                <div className="text-sm font-semibold space-y-5">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <input type="date" value={dateToIso(formData.tanggal_keluar)} onChange={e => setFormData(state => state = {...state, tanggal_keluar: isoToDate(e.target.value)})} className="px-2 py-1 rounded border bg-white w-full font-medium dark:bg-zinc-800 dark:border-zinc-800 dark:text-zinc-200" placeholder="Masukkan Tanggal Keluar" />
                                        </div>
                                    </div>
                                    <div className="space-y-1">
